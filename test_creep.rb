...
"REMEMBER THAT IN DOWNLOAD LOOP, HOW PREVENT ALREADY DOWNLOADED EXCELS FROM REDOWNLOADING, OR IF
  HAVE TO, DELETE FROM FILE WHERE THEY DOWNLOAD TO IF COPY EXISTS!"
